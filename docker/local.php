<?php
 ...
 @define('CONST_Replication_MaxInterval', '312000');     // Process each update separately, osmosis cannot merge multiple updates
 @define('CONST_Replication_Update_Interval', '312000');  // How often upstream publishes diffs
